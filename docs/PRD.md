...
### 4.2 Phase 2 (Auto-Generation) - 완전 자동화 시스템 🆕

#### **Feature 4: 크롤링 사이트 관리**
- **기능 설명**: 사용자가 모니터링할 사이트를 등록하고 관리
- **주요 기능**:
  - 사이트 등록/수정/삭제
  - 사이트별 크롤링 주기 설정 (5분/15분/30분/1시간)
  - 크롤링 상태 실시간 확인
  - 활성화/비활성화 토글
- **기본 등록 사이트** (Microsoft 블로그):
  - https://blogs.microsoft.com/
  - https://news.microsoft.com/source/asia/region/korea/?lang=ko
  - https://www.microsoft.com/en-us/security

#### **Feature 5: 자동 크롤링 시스템**
- **기능 설명**: 등록된 사이트에서 새 게시물을 자동으로 감지하고 수집
- **크롤링 방식**:
  - **RSS 피드 파싱**: `feedparser` 사용, 빠른 업데이트 감지
  - **크롤링 봇**: `Playwright` 사용, JavaScript 렌더링 페이지 지원
...
#### **Feature 8: 이메일 알림 시스템**
- **기능 설명**: 카드뉴스 생성 완료 및 중요 이벤트 시 이메일 발송
- **알림 타입**:
  - 카드뉴스 생성 완료 (프로젝트 링크 포함)
  - 크롤링 실패 알림
  - 주간 요약 리포트
- **설정**:
  - 알림 ON/OFF 토글
...
#### **Feature 9: 메인 대시보드 (3개 메뉴)**
- **기능 설명**: 모든 기능에 접근할 수 있는 중앙 허브
- **메뉴 구성**:
  1. **크롤링 사이트 설정**
     - 등록된 사이트 목록
     - 사이트별 크롤링 상태
...
### 4.3 Phase 3 (Design & Export) - 디자인 및 내보내기 기능

#### **Feature 10: 디자인 커스터마이징**
- AI 대화형 디자인 수정:
  - "색상을 파란색 계열로 바꿔줘"
  - "폰트를 더 굵게 해줘"
  - "이미지를 오른쪽으로 배치해줘"
...
#### **Feature 11: 이미지 생성 및 편집**
- AI 이미지 생성 (DALL-E, Midjourney)
- 이미지 업로드
- 이미지 편집 (크롭, 필터, 텍스트 오버레이)
- Unsplash 연동 (무료 이미지)

#### **Feature 12: 카드뉴스 Export**
- PNG, JPG, PDF 형식 다운로드
- 해상도 선택 (소셜 미디어별 최적화)
- 일괄 다운로드 (ZIP)
- 고해상도 옵션

#### **Feature 13: 사용자 인증 및 협업**
- Firebase Authentication (이메일, Google, GitHub)
- 팀 협업 기능
- 권한 관리
- 프로젝트 공유 및 댓글

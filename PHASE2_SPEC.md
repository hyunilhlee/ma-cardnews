# Phase 2 개발 정의서 - 완전 자동화 시스템

**CardNews AI Generator - Auto-Generation Phase**
...
| 항목 | Phase 1 (수동) | Phase 2 (자동) |
|------|---------------|---------------|
| **콘텐츠 발견** | 사용자가 직접 찾아서 입력 | 시스템이 자동으로 감지 |
...
| 항목 | 내용 |
|------|------|
| **목표** | 100% 자동화 카드뉴스 생성 시스템 |
| **타겟 사이트** | Microsoft 블로그 3개 |
| **핵심 기능** | 크롤링 → 자동 생성 → 저장 → 알림 |
| **기술 스택** | RSS Parser, Playwright, APScheduler, SendGrid |
| **개발 기간** | 4-6주 (42일) |
| **주요 API** | 15+ 엔드포인트 |
| **데이터베이스** | Firestore 4개 컬렉션 |
